...
- [ ] Review status: `cat docs/reference/status.md`
...
cat docs/reference/status.md | head -20
```
...
├── tools/                         # Test tools
├── tests/                         # Test files
├── docs/reference/status.md      # Quick status
├── docs/history/onboarding-complete.md # Session summary
├── docs/guides/agent-onboarding.md # Agent onboarding
├── docs/guides/session-start.md   # This file
...
- `docs/reference/status.md` (must have)
- `docs/history/onboarding-complete.md` (must have)
